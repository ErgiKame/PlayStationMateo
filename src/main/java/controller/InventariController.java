...
public class InventariController extends VBox {
	...
	@FXML
	private JFXButton btnEdit, btnPdf, btnExcel;

	@FXML
	private TableView<Inventari> tblnventari;

	@FXML
	private TableColumn<Inventari, String> tblColArtikulli, tblColGjendja;
	...
	private void loadInventari() throws SQLException {
		...
		tblColArtikulli.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Inventari, String>, ObservableValue<String>>() {
			@Override
	...
	private void excel() {
		try {
			...
			String text = "";
			String header = "Nr" + "," + "Emri i Bojes" + "," + "Gjendja" + "\n";
